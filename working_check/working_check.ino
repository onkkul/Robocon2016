// Onkar Kulkarni
//Simple,test Code for line follower
//Sensor used:LSA08
//baudrate:96000
//processor: AVR_256
#include <PID_v1.h>
...
{
  Serial.print("U0=");
  Serial.println(digitalRead(U0));                              //map ch . to 120 if toggle
  Serial.print("U1=");
...
//###############after execution of every "if" statement, the input from the sensor changes. But, proccessor still compares n executes################################
}
