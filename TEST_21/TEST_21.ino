...
//strate condition     ************   tripel condition  ************
  ...
  {
    lsa.write(65);                                                                                   //(digitalRead(U0)==0)&&(digitalRead(U1)==0)&&(digitalRead(U2) == 0)&&(digitalRead(U3) == 0)&&(digitalRead(U4) == 0)&&(digitalRead(U5) == 0)&&(digitalRead(U6) == 0)&&(digitalRead(U7) == 0)
