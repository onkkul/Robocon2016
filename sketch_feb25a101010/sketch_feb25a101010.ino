...
void loop()
{
  ...
  // move 4word
  while ((digitalRead(U0) == 0) && (digitalRead(U1) == 0) && (digitalRead(U2) == 1) && (digitalRead(U3) == 1) || (digitalRead(U3) == 1) && (digitalRead(U4) == 1) || (digitalRead(U4) == 1) && (digitalRead(U5) == 1) && (digitalRead(U6) == 0) && (digitalRead(U7) == 0))
  {
  //  lsa.write(30);
  ...
  //       move right
  while ((digitalRead(U0) == 0) && (digitalRead(U1) == 0) && (digitalRead(U2) == 0) && ((digitalRead(U3) == 1) || (digitalRead(U4) == 1)) && (digitalRead(U5) == 1) && (digitalRead(U6) == 1) && (digitalRead(U7) == 1))
  {
    lsa.write(150);
  ...
  // move left
  while ((digitalRead(U0) == 1) && (digitalRead(U1) == 1) && (digitalRead(U2) == 1) && ((digitalRead(U3) == 1) || (digitalRead(U4) == 1)) && (digitalRead(U5) ==0 ) && (digitalRead(U6) == 0) && (digitalRead(U7) == 0))
  {
    lsa.write(30);
    trace();
  }
