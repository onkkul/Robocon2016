...
void loop()
{
  ...
  //       move right
  else if ((digitalRead(U0) == 0) && (digitalRead(U1) == 0) && (digitalRead(U2) == 1) && ((digitalRead(U3) == 1) || (digitalRead(U4) == 1)) && (digitalRead(U5) == 1) && (digitalRead(U6) == 1) && (digitalRead(U7) == 1))
  {
    lsa.write(172);
    //delay(40);
