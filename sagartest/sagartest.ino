...
void loop()
{
  ...
  if (((digitalRead(U0) == 1) || (digitalRead(U1) == 1) || (digitalRead(U2) == 1) || (digitalRead(U3) == 1) || (digitalRead(U4) == 1)) && (digitalRead(U5) == 0) && (digitalRead(U6) == 0) && (digitalRead(U7) == 0))
  {
    lsa.write(75);
  ...
  {
    lsa.write(105);                                                                                   //(digitalRead(U0)==0)&&(digitalRead(U1)==0)&&(digitalRead(U2) == 0)&&(digitalRead(U3) == 0)&&(digitalRead(U4) == 0)&&(digitalRead(U5) == 0)&&(digitalRead(U6) == 0)&&(digitalRead(U7) == 0)
 ...
 /* else if ((digitalRead(U0) == 0) && (digitalRead(U1) == 1) && ((digitalRead(U2) == 1) || (digitalRead(U3) == 1)) && (digitalRead(U4) == 0) && (digitalRead(U5) == 0) && (digitalRead(U6) == 0) && (digitalRead(U7) == 0))
  ...
  if ((digitalRead(U0) == 0) && (digitalRead(U1) == 0) && (digitalRead(U2) == 0) && (digitalRead(U3) == 1) && (digitalRead(U4) == 1) && (digitalRead(U5) == 1) && (digitalRead(U6) == 1) && (digitalRead(U7) == 1))
  {
    lsa.write(180);
