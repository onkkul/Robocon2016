...
void loop()
{
  ...
  {
    lsa.write(55);
    Serial.println("on U0, turning ##LEFT## by ##35##");
  }

  else if ((digitalRead(U0) == 1) && ((digitalRead(U1) == 1) || (digitalRead(U2) == 1)) && (digitalRead(U3) == 0) && (digitalRead(U4) == 0) && (digitalRead(U5) == 0) && (digitalRead(U6) == 0) && (digitalRead(U7) == 0))
  {
    lsa.write(60);                                                                                   //(digitalRead(U0)==0)&&(digitalRead(U1)==0)&&(digitalRead(U2) == 0)&&(digitalRead(U3) == 0)&&(digitalRead(U4) == 0)&&(digitalRead(U5) == 0)&&(digitalRead(U6) == 0)&&(digitalRead(U7) == 0)
  ...
  else if ((digitalRead(U0) == 0) && (digitalRead(U1) == 0) && (digitalRead(U2) == 0) && (digitalRead(U3) == 0) && (digitalRead(U4) == 0) && (digitalRead(U5) == 0) && (digitalRead(U6) == 1) && (digitalRead(U7) == 1))
  {
    ...
    Serial.println("on U6 & U7,turning ##RIGHT## by ##35##");
  }
  ...
  {
    lsa.write(135);
    Serial.println("on U7,turning ##RIGHT## by ##45##");
  }
